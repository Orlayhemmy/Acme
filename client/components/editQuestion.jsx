...
import { createQuestion, modifyQuestion } from '../actions/questionActions';
...
export default class EditQuestion extends React.Component {
  ...
  onSubmit(e) {
    e.preventDefault();
    if (this.isValid()) {
      this.props.dispatch(modifyQuestion(this.props.test.test.id, this.state));
     }
        ...
        <main class="col-xs-12 col-sm-12 col-lg-12 col-xl-12 pl-4">
          ...
          <section class="row">
            <div class="col-sm-12 col-md-8">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <textarea id="content" class="form-control" onChange={this.onChange} value={content} name="ckeditor"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-2 no-padding">
                          <input type="text" id="point" class="form-control" onChange={this.onChange} value={point}/>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check-inline col-lg-6">
                          <input type="text" id="opt_a" class="form-control" onChange={this.onChange} value={opt_a}/>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check-inline col-lg-6">
                          <input type="text" id="opt_b" class="form-control" onChange={this.onChange} value={opt_b}/>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check-inline col-lg-6">
                          <input type="text" id="opt_c" class="form-control" onChange={this.onChange} value={opt_c}/>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check-inline col-lg-6">
                          <input type="text" id="opt_d" class="form-control" onChange={this.onChange} value={opt_d}/>
                        </div>
              ...
              <Link to="/testquestions"><p>Back to questions</p></Link>
            </div>
